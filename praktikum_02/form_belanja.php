...
<body>
  ...
  <div class="container mt-5"><hr>
	<div class="row">
	<div class="col-md-8">
      <!-- ini adalah form belanja alat elektronik -->
    <form method="POST">
  ...
  <div class="form-group row mt-5">
    <div class="offset-4 col-5">
      <input type="submit" nama="submit" nama="simpan" value= "Simpan">
    </div>
  </div>
</form>		</div>
    <!-- penutup form belanja alat elektronik -->

    <!-- ini adalah tabel daftar harga -->
		<div class="col-md-4">
			<div class="card">
    ...
    <!-- penutup daftar tabel harga  -->
	<hr>
    <?php require_once "nilai_belanja.php"; ?>
